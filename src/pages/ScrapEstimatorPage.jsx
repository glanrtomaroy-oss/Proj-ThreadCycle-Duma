...
function ScrapEstimatorPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-[#7a8450] to-[rgba(38,70,83,0.8)] bg-cover bg-center text-white py-20 text-center bg-[url('https://images.unsplash.com/photo-1558769132-cb1aea458c5e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1500&q=80')]" id="scrap-estimator">
                ...
                <div className="max-h-[400px] overflow-y-auto border border-gray-300 rounded-lg bg-white flex-1">
                  <div className="flex flex-col gap-4 p-4">
                    {filteredCalculations.map((calc) => (
                      <div key={calc.id} className="flex justify-between items-center p-4 border border-gray-300 rounded-md transition-all hover:border-[#4c5f0d] hover:-translate-y-0.5">
                        <div className="flex-1">
                          <div className="flex justify-between items-center mb-2">
                            <h4 className="text-gray-800 font-medium">{calc.fabricType}</h4>
                            <span className="text-xs text-gray-600">{calc.date}</span>
                          </div>
                          <div className="grid grid-cols-3 gap-4 mt-2">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="font-semibold text-green-600 text-sm">{calc.saved.toFixed(2)}m</span>
                            </div>
                          </div>
                        </div>
                        <div className="flex flex-col items-end gap-2">
                          <span className="bg-green-600 text-white px-2 py-1 rounded-full font-medium text-sm">+{calc.saved.toFixed(2)}m</span>
